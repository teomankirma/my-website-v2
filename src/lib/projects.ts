...
export type ProjectKey =
  ...
  | 'teoAi' | 'productListing' | 'jobFlow' | 'cirkle' | 'clueClash';
...
export const PROJECTS: Project[] = [
  {key: 'clueClash', title: 'Clue Clash', image: clueClash, technologies: 'React Native, Expo, TypeScript', href: 'https://bytesandpixels.co/clue-clash/'},
